...
class Debugger
{
 ...
 require_once(\ProcessWire\wire('files')->compile(dirname(\ProcessWire\wire("config")->paths->root . 'site/modules/TracyDebugger/tracy-2.9.x/src/Tracy/Debugger') . "/$path.php",array('includes'=>true,'namespace'=>true,'modules'=>false,'skipIfNamespace'=>false)));
		}
