...
<?php $vacancies = $pages->find('template=vacancy') ?>

<section class="section">
    <div class="container u-position-relative">
        <div class="row">
            <div class="col-lg-4">
                <div class="u-h2 u-mb-4">Все вакансии <span class="u-color-gray u-font-light">(67)</span></div>
                <div class="offers-list">
                    <?php foreach ($page->children as $p): ?>
                    
                        <div class="custom-checkbox u-mb-4">
                            <input class="custom-checkbox__input" type="checkbox" id="<?= $p->id ?>" name="<?= $p->id ?>" value="<?= $p->id ?>">
